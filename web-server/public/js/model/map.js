__resources__["/map.js"] = {
  ...
  data: function(exports, require, module, __filename, __dirname) {
    ...
    class Map {
      ...
      forAllReachable(x, y, processReachable) {
        var x1 = x - 1,
          x2 = x + 1
        var y1 = y - 1,
          y2 = y + 1
       ...
       */
      _move(sx, sy, ex, ey, time, onFrameEnd) {
        this.moveAnimation = new animate.MoveTo(
          [0, { x: sx, y: sy }, "linear"],
       ...
       */
      _checkPosition(sdist, time, osx, osy) {
        var mpos = this.position()
        var spos = getCurPlayer()
          .getSprite()
          .getPosition()
      ...
      checkMapBoundary(distX, distY, position) {
        var moveFlag = false
